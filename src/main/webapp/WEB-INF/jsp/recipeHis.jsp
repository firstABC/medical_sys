						...
						<div class="header_top">
							<div class="top_right">
								<ul>
									...
									<li><a href="javascript:;">历史处方</a></li>
								</ul>
							</div>
				...
				<div class="content">
					<div class="monthly-grid">
						<div class="panel-widget">
							<div class="panel panel-title">历史处方</div>
								...
								<div class="tableBox">
									<div class="searchList">
										...
										<div class="searchType">
											<label>医生</label>
											<c:choose>
												<c:when test="${physician != null && physician != ''}">		
													<input type="text" name="" value="${physician }" class="form-control" id="physician">
												</c:when>
												<c:otherwise>
													<input type="text" name="" value="" class="form-control" id="physician"> 
												</c:otherwise>
											</c:choose>
										</div>
   	...
   	$(document).ready(function () {
		//查询卡号病历
         $('#selectBtn').on('click', function(){
        	var icCardNumC = $('#icCardNumC').val();
        	var physician = $('#physician').val();
        	window.location.href="<%=basePath%>/pp/pr.abc?icCardNum="+icCardNumC+"&physician="+physician;
		});
	});
   	</script>
